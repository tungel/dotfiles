...
# 'screenshot- 2022-01-21 at 19.11.54.png' -> '2022-01-21-opnsense-001.jpg'
# 'screenshot- 2022-01-21 at 19.11.55.png' -> '2022-01-21-opnsense-002.jpg'
...
for current_name in *.png; do
  new_name=$(printf "$BASE_NAME-%03d.jpg" "$a")
